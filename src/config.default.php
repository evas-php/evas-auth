...
return [
    'errors' => [
        ...
        // A::ERROR_SOURCE_CONTROLLER_NOT_SUPPORTED => 'Обработчик аутентификации через %s не поддерживается',
        // A::ERROR_SOURCE_CONTROLLER_NOT_FOUND => 'Обработчик аутентификации через %s не найден',
        // A::ERROR_SOURCE_CONTROLLER_ACTION_NOT_FOUND => 'Действие %s обработчика аутентификации через %s не найдено',
        // A::ERROR_MODEL_TABLE_NOT_FOUND => 'Имя таблицы модели данных %s не найдено',
        // A::ERROR_USER_NOT_FOUND => 'Пользователь не найден',
        // A::ERROR_USER_FAIL_PASSWORD => 'Неверный пароль',
        // A::ERROR_VALIDATOR => 'Неверное имя пользователя/пароль',
        // A::ERROR_USER_ALREADY_EXISTS => 'Пользователь уже существует',
        // A::ERROR_AUTH_GRANT_NOT_FOUND => 'Способ входа не найден',
        // A::ERROR_AUTH_GRANT_CONFIRM_NOT_FOUND => 'Способ входа не найден или уже подтвержден',
        // A::ERROR_AUTH_GRANT_RECOVERY_NOT_FOUND => 'Восстановление доступа с таким кодом не найдено',
    ],
